...
public class Scenario3 {
	...
	public void user_enters_login_credentials(DataTable dataTable) throws Exception {
		List<List<String>> credentials = credentials("C:\\Users\\Admin\\eclipse-workspace\\PageFactoryCode\\src\\test\\resources\\Testdata.xlsx");
		...
		Page1.userPasswordEnter(dataTable.cell(0, 1));
	}
